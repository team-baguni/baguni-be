...
public class SeleniumCrawler {
	...
	private final SeleniumOption seleniumOption;

	public SeleniumCrawler(SeleniumOption seleniumOption) {
	...
	public Map<String, String> crawl(URI uri) throws SeleniumException {
		...
		try {
			// 페이지 로딩 타임아웃 설정
			driver.manage().timeouts().pageLoadTimeout(seleniumOption.getHttpRequestTimeoutyDuration());
	...
	private WebDriver chromeOptionSetting() {
		...
		options.addArguments("--user-agent=" + seleniumOption.getUserAgent());
